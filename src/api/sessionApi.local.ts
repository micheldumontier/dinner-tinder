// Mock backend for shared dinner sessions (the default when VITE_API_URL is
// unset — see sessionApi.ts for the switch).
//
...
// The real REST/SSE equivalent lives in sessionApi.http.ts and the server/
